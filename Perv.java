...
class Perv
{
    ...
    public static void main(String[] args) {
        ...
        /* Четвертая задача */
        System.out.println(Perv.Four());
        /* Пятая задача */
        System.out.println(Perv.Five());
        /* Шестая задача */
        System.out.println(Perv.Six());
        /* Седьмая задача */
        System.out.println(Perv.Seven());
        /* Восьмая задача */
        System.out.println(Perv.Eight());
        /* Девятая задача */
        System.out.println(Perv.Nine());
        /* Десятая задача */
        System.out.println(Perv.Ten());
        /* Одиннадцатая задача */
        System.out.println(Perv.Eleven());
        /* Двенадцатая задача */
        System.out.println(Perv.Twelve());
